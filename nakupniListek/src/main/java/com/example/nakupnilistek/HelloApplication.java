...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) {
        Label l = new Label("nic");
        Label l2 = new Label("nic");
        Label l3 = new Label("nic");
        Label l4 = new Label("nic");
        Label l5 = new Label("nic");
        Label l6 = new Label("nic");
        Label l7 = new Label("nic");
        Label l8 = new Label("nic");
        Label l9 = new Label("nic");
        Label l10 = new Label("nic");
